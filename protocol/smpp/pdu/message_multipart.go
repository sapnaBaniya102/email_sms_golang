...
import (
	"fmt"
	coding2 "github.com/sujit-baniya/smpp/coding"
)

func ComposeMultipartShortMessage(input string, coding coding2.DataCoding, reference uint16) (parts []ShortMessage, err error) {
